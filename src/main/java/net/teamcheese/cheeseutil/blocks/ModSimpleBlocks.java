...
public class ModSimpleBlocks {
    ...
    ));public static final DeferredBlock<Block> YELLOW_MOSS_CARPET = registerBlock("yellow_moss_carpet",
    ...
    public static final DeferredBlock<Block> BLUE_MOSS_CARPET = registerBlock("blue_moss_carpet",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.MOSS).instabreak().noCollission()
    ...
    public static final DeferredBlock<Block> RED_MOSS_CARPET = registerBlock("red_moss_carpet",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.MOSS).instabreak().noCollission()
